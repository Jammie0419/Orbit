...
| `skills/` | Phase 3(Hermes-Style Skill Evolution: 技能自动生成 + GEPA 进化 + Nudge + 质量路由) | `skill_evolution_live.py` | 真实 LLM 统计账本聚合、轨迹→自编写技能生成(落盘 + 双 marker)、Nudge 本轮到期与失败技能检出、GEPA 种群进化的接受/拒绝与版本号(2026-09-03) |
