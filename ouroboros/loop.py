...
def _inject_round_checkpoints(
    *,
    ...
    # TB optimization: surface a debug-loop warning once tool failures pile up.
...
def _maybe_inject_debug_loop_warning(
    ...
    """Inject the pending debug-loop warning queued by consecutive tool failures.

    The queue is filled in loop_tool_execution.process_tool_results; draining it here
    keeps the injection on the same tail-of-round path as the other checkpoints.
    """
